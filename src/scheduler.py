...
class Scheduler:
    ...
    def run_download(self):
        ...
        try:
            ...
            logger.info(f"Scheduled download completed. Downloaded {len(downloaded_files)} files")
    ...
    def run_continuous(self):
        ...
        logger.info(f"Starting continuous scheduler (interval: {self.interval_hours} hours)")
